...
<?php get_header(); ?>
    ...
    <div class="about-pricing">
        ...
        <div class="wrap">
            <h2>Pricing</h2>
                ...
                <p class="financing-link">Financing available! <span><a hre="#">Learn More</a></span></p>          
            </div>
        </div>
        <div class="col">
    ...
    <div class="branding">
        <div class="container">
            ...
            <div class="brands">
                <div class="col">
                    <img src="<?php echo esc_url(get_template_directory_uri() );?>/images/logo-kenmore@2x.png" alt=""></li> 
                </div>
                <div class="col">
                    <img src="<?php echo esc_url(get_template_directory_uri() );?>/images/logo-kenmore@2x.png" alt=""></li> 
                </div>
