...
function peak_scripts() {
	...
	wp_enqueue_style( 'main-style', get_template_directory_uri() . '/css/peak.css', array(), '1.1', 'all' );
	...
	wp_enqueue_script( 'main-peak', get_template_directory_uri() . '/js/main.js', array('jquery'), '1.0', true );
}
