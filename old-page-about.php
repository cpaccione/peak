...
<?php get_header(); ?>
    ...
    <div class="container-1000">
        <div class="appliance">
            <div class="col-left">
                <div class="wrap">
                    <h2>Chicagoland Appliance Repair Experts</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea.</p>
                </div>
            </div>
            <div class="col-right">
                <img src="<?php echo esc_url(get_template_directory_uri() ); ?>/images/fad_large.svg" alt="Factory Authorized Dealer">
            </div>
    ...
    <div class="branding">
        ...
        <div class="brands">
            <div class="col">
                <img src="<?php echo esc_url(get_template_directory() );?>/images/logo-kenmore.svg" alt=""></li> 
            </div>
            <div class="col">
                <img src="<?php echo esc_url(get_template_directory() );?>/images/logo-kenmore.svg" alt=""></li> 
            </div>
        ...
        <div class="add-info">
            <p>Don’t see your appliance brand? No problem! Most appliances share common parts. If you know the brand and model number, give us a call and we’ll see if we can service your machine.</p>
        </div>
    </div>
